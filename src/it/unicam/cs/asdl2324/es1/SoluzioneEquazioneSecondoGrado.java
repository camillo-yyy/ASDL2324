...
public class SoluzioneEquazioneSecondoGrado {
    ...
    final EquazioneSecondoGradoModificabileConRisolutore e;
     ...
     */
    public SoluzioneEquazioneSecondoGrado(EquazioneSecondoGradoModificabileConRisolutore e) {
        if (e == null)
     ...
     *                                  se l'equazione passata è nulla
     */
    public SoluzioneEquazioneSecondoGrado(EquazioneSecondoGradoModificabileConRisolutore e, double s1) {
        if (e == null)
            throw new NullPointerException(
                    "Tentativo di creare una soluzione di una equazione nulla");
        this.e = e;
