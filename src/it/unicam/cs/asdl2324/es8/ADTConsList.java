...
public interface ADTConsList<E> {
    ...
    default ADTConsList<E> removeAll(E element) {
        ...
        // caso ricorsivo
        if (this.first().equals(element)) 
            // se è un elemento da rimuovere eseguo solo la chiamata ricorsiva
    ...
    default ADTConsList<E> updateFirst(E element, E newElement) {
        ...
        // caso ricorsivo
        if (this.first().equals(element))
            // aggiorno la prima occorrenza, concatenando il nuovo elemento al resto
    ...
    default ADTConsList<E> updateAll(E element, E newElement) {
        ...
        // caso ricorsivo
        if (this.first().equals(element))
            // chiamata ricorsiva, dove sul valore di ritorno concatenerò la nuova occorrenza
    ...
    default ADTConsList<E> append(ADTConsList<E> list) {
        ...
        if (this.rest().isEmpty())
            return list.cons(this.first()); // concateno ricorsivamente tutti gli elementi di questa lista all'altra 
        // caso ricorsivo
    ...
    default ADTConsList<E> reverse() {
        ...
        if (this.rest().isEmpty())
            return this;
        // caso ricorsivo
        // l'elemento non viene concatenato in testa (come sopra) ma bensì aggiunto in fondo 
        return this.rest().reverse().append(new ConsList<E>(this.first())); 
    }
